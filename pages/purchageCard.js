...
const purchageCard = () => {
    const cardinfo = [
        ...
        {
            product_image: "/images/cardimage3.png",
            product_title: "Pericardial",
            product_code: "DDLN23M",
        },

        {
            product_image: "/images/cardimage1.png",
  ...
  },
  {
    ...
    return (
        <div className="space-y-4">
            <div className="text-[#03111F] text-[20px] leading-[24.2px] font-semibold">
                Create Purchage Order
            </div>
            <div className="w-[100%]">
            <div className="flex gap-4 overflow-x-auto overflow-hidden px-1">
                {cardinfo.map((card) => (
                  <div className="min-w-[23.8%]">
